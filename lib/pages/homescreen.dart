                          ...
                          Column(
                            children: groupedRoutes.entries.map((entry) {
                              ...
                              if (routes.isNotEmpty) {
                                routes.sort(
                                  (a, b) => a.stopArrivalTime.compareTo(
                                    b.stopArrivalTime,
                                  ),
                                );
                              ...
                              for (var r in routes) {
                                if (r.stopName.toLowerCase().contains(
                                  'onboard',
                                )) {
                                  onboardTime = r.stopArrivalTime;
                                } else if (r.stopName.toLowerCase().contains(
                                  'offboard',
                                )) {
    ...
    try {
      ...
      if (data[0]['result'] == 'ok') {
        ...
        for (var subscription in subscriptionData) {
          ...
          Logger().i('ksdghosdifughid' + studentSubscriptions.toString());
